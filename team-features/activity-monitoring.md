...
2) **Versions tab of in image preview:**  Displays all image changes: metadata changes, when it's opened in a share, annotations, versions, etc.

3) **Dashboard:**  A less detailed view providing a quick overvew of recent activity.

4) **Sort by activity type:** Provides a full look at all images reently viewed, updated and added.
...
Its it also useful to simply get a full history of the images, from when it was initially added, to potentially years later as data was edited, comments made, and new versions uploaded.

All activities shown in the Audit Trail type dropdown which relates to an image will show here. 
...
The dashboard provides a quick view of Recently added, updated and viewed images.  As importantly, to the right of the widget title is the counts for the specific activty for Today (last 24 hours), This week (past 7 days), and This month (past 30 days).  It's a quick means to see if there has been activity across the system today, or how much use it's gotten in the past while.  Answering questions such as "has anyone been adding images recently" or "is the team and clients gettting usage of the system by viewing images". (Note: the Recently Viewed widget isn't shown in the example below but can be added from the Dashboard configuration page.)
